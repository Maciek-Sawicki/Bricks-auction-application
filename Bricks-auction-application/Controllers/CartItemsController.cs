...
namespace Bricks_auction_application.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        {
            ViewData["CartId"] = new SelectList(_context.Carts, "UserId", "UserId");
        ...
        public async Task<IActionResult> Create([Bind("CartItemId,Quantity,CartId,OfferId")] CartItem cartItem)
        {
            ...
            ViewData["CartId"] = new SelectList(_context.Carts, "UserId", "UserId", cartItem.CartId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartItemId,Quantity,CartId,OfferId")] CartItem cartItem)
        {
