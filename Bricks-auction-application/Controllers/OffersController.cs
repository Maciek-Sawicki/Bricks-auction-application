...
namespace Bricks_auction_application.Controllers
{
    public class OffersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OfferId,UserId,LEGOSetId,Price,Quantity,OfferEndDateTime")] Offer offer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OfferId,UserId,LEGOSetId,Price,Quantity,OfferEndDateTime")] Offer offer)
        {
            if (id != offer.OfferId)
            {
                return NotFound();
